...
public interface Covid19VaccinationScheduleRepository extends JpaRepository<Covid19VaccinationSchedule, Integer> {
    ...
    @Query(value = "SELECT cs FROM Covid19VaccinationSchedule cs INNER JOIN FETCH cs.covid19VaccinationVenue cv ORDER BY cs.availabilityDate, cs.availabilityCount")
